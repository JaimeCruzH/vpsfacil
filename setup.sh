...
print_banner() {
    ...
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}%-62s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}  ${COLOR_BOLD_GREEN}██╗   ██╗██████╗ ███████╗███████╗ █████╗  ██████╗██╗██╗${COLOR_RESET}%-14s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}  ${COLOR_BOLD_GREEN}██║   ██║██╔══██╗██╔════╝██╔════╝██╔══██╗██╔════╝██║██║${COLOR_RESET}%-14s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}  ${COLOR_BOLD_GREEN}██║   ██║██████╔╝███████╗█████╗  ███████║██║     ██║██║${COLOR_RESET}%-14s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}  ${COLOR_BOLD_GREEN}╚██╗ ██╔╝██╔═══╝ ╚════██║██╔══╝  ██╔══██║██║     ██║██║${COLOR_RESET}%-14s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}  ${COLOR_BOLD_GREEN} ╚████╔╝ ██║     ███████║██║     ██║  ██║╚██████╗██║███████╗${COLOR_RESET}%-6s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}  ${COLOR_BOLD_GREEN}  ╚═══╝  ╚═╝     ╚══════╝╚═╝     ╚═╝  ╚═╝╚═════╝╚═╝╚══════╝${COLOR_RESET}%-6s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}%-62s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}  ${COLOR_BOLD_CYAN}Instalación Automatizada de VPS v1.0${COLOR_RESET}%-20s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}  ${COLOR_WHITE}Debian 12 · Docker · Tailscale VPN${COLOR_RESET}%-20s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    printf "${COLOR_BOLD_BLUE}║${COLOR_RESET}%-62s${COLOR_BOLD_BLUE}║${COLOR_RESET}\n" ""
    echo -e "${COLOR_BOLD_BLUE}╚══════════════════════════════════════════════════════════════╝${COLOR_RESET}"
    echo ""
}
